<?php
	class CSRF
	{
		public static function checkToken ($_key, $_origin, $_timespan = null)
		{
			...
			if (sha1($_SERVER['REMOTE_ADDR'] . $_SERVER['HTTP_USER_AGENT']) != substr(base64_decode($hash), 10, 40)) return false;
		...
		public static function generateToken ($_key)
		{
